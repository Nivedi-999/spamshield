            ...
            <Grid item xs={12} md={6}>
              <Box sx={{ p: 3 }}>
                ...
                <Typography variant="body1" color="text.secondary" sx={{ mb: 4, maxWidth: 500 }}>
                  SpamShield uses machine learning, AI analysis, and rule-based detection to identify and protect you from sophisticated phishing attempts.
                </Typography>
                ...
                <Box sx={{ position: 'relative', zIndex: 1, width: '100%' }}>
                  ...
                  <Button
                    ...
                    sx={{ 
                      ...
                      width: '100%',
                      mb: 3,
                      background: 'linear-gradient(45deg, #65dbf0ff 0%, #1d47dfff 100%)',
                      boxShadow: '0 4px 15px rgba(58, 123, 213, 0.3)',
                      '&:hover': {
                        boxShadow: '0 6px 20px rgba(236, 64, 16, 0.92)',
                      }
                    }}
                  >
                    Sign in with Google
