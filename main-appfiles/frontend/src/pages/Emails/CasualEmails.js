// src/pages/emails/CasualEmails.js
...
const CasualEmails = () => {
  ...
  useEffect(() => {
    const fetch = async () => {
      try {
        const data = await getEmails(1, 50, { tag: 'casual' });
  ...
  return (
    <Box>
      <Typography variant="h4" gutterBottom>Casual Emails</Typography>
      <Paper>
        <TableContainer>
          <Table>
            <TableHead>
